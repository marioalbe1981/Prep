...
// const nuevoBool =  null; // o false
const nuevoBool = true; // o false
...
function tienenMismaLongitud(str1, str2) {
  ...
  // return str1.length === str2.length; // seria lo mismo
...
function esVocal(letra){
  ...
  //ejemplo a letra mascula o minuscula -  depende que letra pasaron
